            ...
            if (((this.progress = 0), this.vars && this.kill(1), Je)) {
                ...
                (Te.media = We),
                    ...
                    se &&
                        ...
                        (n = Me.core.getCache(se)).spacer ? (z = n.pinState) : ((n.spacer = B = Pe.createElement("div")), B.setAttribute("class", "pin-spacer" + (i ? " pin-spacer-" + i : "")), (n.pinState = z = db(se))),
                    ...
                    (Te.refresh = function (e) {
                        if (!Re && Te.enabled)
                            if (se && e && De) xa(ScrollTrigger, "scrollEnd", Qa);
                                ...
                                for (P = gb(v, ae, c, te, Te.scroll(), O, I, Te, u, ye, be, f) || (se ? -0.001 : 0), T(g) && (g = g(Te)), S(g) && !g.indexOf("+=") && (~g.indexOf(" ") ? (g = (S(v) ? v.split(" ")[0] : "") + g) : ((d = Ca(g.substr(2), c)), (g = S(v) ? v : P + d), (h = ae))), _ = Math.max(P, gb(g || (h ? "100% 0" : f), h, c, te, Te.scroll() + d, E, R, Te, u, ye, be, f)) || -0.001, A = _ - P || ((P -= 0.01) && 0.001), d = 0, m = b; m--; )
                                ...
                                if (((P += d), (_ += d), (Te._pinPush = p), O && d && (((t = {})[te.a] = "+=" + d), Me.set([O, E], t)), se))
                                    (t = qa(se)),
                                        ...
                                        (r = nt(se, !0)),
                                        (l = be && M(he, o ? tt : rt)()),
                                        le && (((j = [le + te.os2, A + p + et]).t = B), (m = le === Ze ? ua(se, te) + A + p : 0) && j.push(te.d, m + et), ct(j), be && Te.scroll(G)),
                                        be &&
                                            (((i = { top: r.top + (o ? n - P : l) + et, left: r.left + (o ? l : n - P) + et, boxSizing: "border-box", position: "fixed" })[Ke] = i.maxWidth = Math.ceil(r.width) + et),
                                ...
                                else if (ae && Te.scroll()) for (r = ae.parentNode; r && r !== Oe; ) r._pinOffset && ((P -= r._pinOffset), (_ -= r._pinOffset)), (r = r.parentNode);
                    ...
                    (Te.update = function (e, t) {
                        ...
                        if ((t && ((k = C), (C = s), de && ((X = m), (m = y && !ge ? y.totalProgress() : c))), ue && !c && se && !Re && !Be && De && P < s + ((s - k) / (He() - Ie)) * ue && (c = 1e-4), c !== u && Te.enabled)) {
                            ...
                            !de || p.tween || Re || Be || Z.restart(!0),
                                ...
                                !re || ge || e || re(Te),
                                i && !Re
                                    ? ((n = c && !u ? 0 : 1 === c ? 1 : 1 === u ? 2 : 3), ge && ((o = (!a && "none" !== xe[n + 1] && xe[n + 1]) || xe[n]), y && ("complete" === o || "reset" === o || o in y) && ("complete" === o ? y.pause().totalProgress(1) : "reset" === o ? y.restart(!0).pause() : y[o]()), re && re(Te)), (!a && qe) || (oe && a && oe(Te), me[n] && me[n](Te), fe && (1 === c ? Te.kill(!1, 1) : (me[n] = 0)), a || (me[(n = 1 === c ? 1 : 3)] && me[n](Te))))
                                    : ge && re && !Re && re(Te);
                        }
